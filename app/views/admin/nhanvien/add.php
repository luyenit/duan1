                    ...
                    <div class="container">
                        <form action="index.php?act=nv&type=add" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ten_nd" name="ten_nd" placeholder="Nhập tên nhân viên" value="<?= $_POST["ten_nd"]??"" ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="id_cv" name="id_cv">
                                    ...
                                    <option value="2" <?= $select2??"" ?> >Nhân viên</option>
                                </select>
                            </div>
                            ...
                            <?= $message??"" ?>
                            <button type="submit" class="btn btn-primary mb-3" name="addnv" value="addnv">Thêm Nhân Viên</button>
                        </form>
                    </div>
                </div>
            </div>
